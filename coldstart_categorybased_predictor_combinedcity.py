...
with open('C:/LearningMaterials/Kaggle/YelpRecSys/yelp_training_set/yelp_training_set_business.json') as data_file:
    for line in data_file:
        ...
        for category in categories:
            ...
            if category+data[u'city'] not in category_stars:
                category_stars[category+data[u'city']] = [data[u'stars']]
            else:
                category_stars[category+data[u'city']].append(data[u'stars'])
    ...
    for line in data_file:
        ...
        if data[u'user_id'] in user_ratings_mean and data[u'business_id'] in business_ratings_mean:
            ...
            for category in test_bus_categories:
                if category+test_bus_city in category_average:
                    cat_avg_list.append(category_average[category+test_bus_city])
